...
app.get("/", (req, res) => {
  res.send("<h2>Home page</h2>") // щоб відправити розмітку
})
//якщо прийде гет запит на '/contacts', то виконати цю функцію
app.get('/contacts', (req, res) => {
//   console.log(req.url) // адреса, з якої прийшов запит
// console.log(req.method)
// console.log(req.headers)
res.send("<h2>Contact page</h2>") //відправляє відповідь
})
